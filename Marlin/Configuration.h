...
#define STRING_CONFIG_H_AUTHOR "(TheArne4, Tevo Tarantula Pro)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "TheArne4-Tarantula"
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -39, 42, -1.5 }
